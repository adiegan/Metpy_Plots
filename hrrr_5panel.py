...
for i in range(0,49):
    ...
    ax1.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax2.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax3.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax4.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax5.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    for i in range(len(stations)):
        station = stations[i]
        lat = coords[i][0]
        lon = coords[i][1]
    ...
    ax6.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ...
    ax9.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    plt.savefig(output_dir+'/HRRR_ex/NE_clouds_'+dtfs+'_.png',bbox_inches='tight',pad_inches=0.1)
    ax9.set_extent((275,277,35,37))
    ...
    ax10.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax11.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax12.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    ax13.set_extent((270, 282, 30, 40))#, crs = zH5_crs)    # Set a title and show the plot
    plt.savefig(output_dir+'/HRRR_ex/ne_accum_ptype_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ax10.set_extent((275,277,35,37))
    ax10.add_feature(USCOUNTIES.with_scale('5m'), edgecolor='dimgray')
    ax11.set_extent((275,277,35,37))
    ax11.add_feature(USCOUNTIES.with_scale('5m'), edgecolor='dimgray')
    ax12.set_extent((275,277,35,37))
    ax12.add_feature(USCOUNTIES.with_scale('5m'), edgecolor='dimgray')
    ax13.set_extent((275,277,35,37))

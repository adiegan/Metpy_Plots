...
mkdir_p(output_dir)
mkdir_p(output_dir+'/NAM12_fronto')
...
for i in range(1,121):
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/NAM12_fronto/ec_h7fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ax.set_extent((266,280,30,40))
    plt.savefig(output_dir+'/NAM12_fronto/ne_h7fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/NAM12_fronto/ec_h8fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ax2.set_extent((260,295,25,50))
    plt.savefig(output_dir+'/NAM12_fronto/ne_h8fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/NAM12_fronto/ec_h9fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ax3.set_extent((266,280,30,40))
    plt.savefig(output_dir+'/NAM12_fronto/ne_h9fgen_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ...
    plt.savefig(output_dir+'/NAM12_fronto/ec_fgencomp_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    ax4.set_extent((266,280,30,40))
    plt.savefig(output_dir+'/NAM12_fronto/ne_fgencomp_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    print(dtfs+' done')

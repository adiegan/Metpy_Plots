...
#              + "("+ str(ob.getGeometry()) + ")" \
    ...
    h = Hodograph(ax=None, component_range=80)
    ...
    plt.savefig((output_dir+'/Soundings/GFS/STL/'+str(int(fcstHour)/60/60)+'.png'),bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.clf()
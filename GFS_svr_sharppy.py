...
for i in range(0,140):
    ...
    #omega_sounding = np.insert(Omega[0])
    ...
    #omega_skewt = Omega_sounding[p_sounding <= SFCP[0,ilat[0][0], ilon[1][0]]]
    ...
    sfccape6 = round(sfccape6)
    sfccape3 = sfcpcl.b3km
    sfccape3 = round(sfccape3)
    #sfccape1 = sfcpcl.b1km
    #sfccape1 = np.round(sfccape1, 1)
    mucape6 = mupcl.b6km
    mucape6 = round(mucape6)
    mucape3 = mupcl.b3km
    mucape3 = round(mucape3)
    #mucape1 = mupcl.b1km
    ...
    #srheil = winds.helicity(prof, ebot_hght, etop_hght, stu = srwind[0], stv = srwind[1])[0]
    #srh_lcl_lfc = winds.helicity(prof, lcl, lfc, stu = srwind[0], stv = srwind[1])[0]
    #srh_lcl_lfc = np.round(srh_lcl_lfc,1)
    ...
    mean_3 = winds.mean_wind_npw(prof, pbot=sfc, ptop=3000., stu = srwind[0], stv = srwind[1])[0]
    mean1 = winds.mean_wind_npw(prof, pbot=sfc, ptop=1000., stu = srwind[0], stv = srwind[1])[0]
    meanpbl = winds.mean_wind_npw(prof, pbot=sfc, ptop=pbl, stu = srwind[0], stv = srwind[1])[0]
    meanpbl = round(meanpbl)
    print(mean1_3)
    ...
    #Use MetPy to get the RH interpolations and pressure-weighted layers
    mpwrh_13 = mean_pressure_weighted(p_skewt[::-1], RH_skewt[::-1], height=hgt_skewt[::-1]-hgt_skewt[-1], bottom=1000*units('meter'), depth=2000 * units.meter)[0].magnitude
    mpwrh_13 = round(mpwrh_13)
    mpwrh_36 = mean_pressure_weighted(p_skewt[::-1], RH_skewt[::-1], height=hgt_skewt[::-1]-hgt_skewt[-1], bottom=3000*units('meter'), depth=3000 * units.meter)[0].magnitude
    mpwrh_69 = mean_pressure_weighted(p_skewt[::-1], RH_skewt[::-1], height=hgt_skewt[::-1]-hgt_skewt[-1], bottom=6000*units('meter'), depth=3000 * units.meter)[0].magnitude
    #mpwrh_69 = np.nan
    #Use MetPy to interpolate to the 3, 6, and 9km levels
    rh1 = metinterp(1000*units('meter'), hgt_skewt[::-1]-hgt_skewt[-1], RH_skewt[::-1])[0].magnitude 
    rh3 = metinterp(3000*units('meter'), hgt_skewt[::-1]-hgt_skewt[-1], RH_skewt[::-1])[0].magnitude
    rh6 = metinterp(6000*units('meter'), hgt_skewt[::-1]-hgt_skewt[-1], RH_skewt[::-1])[0].magnitude
    rh9 = metinterp(9000*units('meter'), hgt_skewt[::-1]-hgt_skewt[-1], RH_skewt[::-1])[0].magnitude
    ...
    lr_36 = params.lapse_rate(prof, 3000., 6000., pres=False)
    lr_36 = np.round(lr_36,1)
    lapse1 = params.lapse_rate(prof, 0., 1000., pres=False)
    lapse1 = np.round(lapse1,1)
    lapse2 = params.lapse_rate(prof, 0., 2000., pres=False)
    lapse2 = np.round(lapse2,1)
    lapse3 = params.lapse_rate(prof, 0., 3000., pres=False)
    lapse3 = np.round(lapse3,1)
    lapse6 = params.lapse_rate(prof, 0., 6000., pres=False)
    lapse6 = np.round(lapse6,1)
    all_lr = params.max_lapse_rate(prof, lower=2000, upper=6000, interval=250, depth=2000)
    all_lr = np.round(all_lr,1)
    ...
    # 0-6 (1000-500 hPa),3-6 km (700-500 hPa) lapse rate,and average rh from 700-400 hpa
        lapse1=(lapse_rate(T_skewt[0],T_skewt[4],[0],hgt_skewt[4]))
        lapse2=(lapse_rate(T_skewt[0],T_skewt[8],hgt_skewt[0],hgt_skewt[8]))
        lapse3=(lapse_rate(T_skewt[0],T_skewt[12],hgt_skewt[0],hgt_skewt[12]))
        lapse6=(lapse_rate(T_skewt[0],T_skewt[20],hgt_skewt[0],hgt_skewt[20]))
        lapse3_6=(lapse_rate(T_skewt[12],T_skewt[20],hgt_skewt[12],hgt_skewt[20]))
        avgrh=np.mean(rh[12:21])
    elif len(p_skewt)==36:
        lapse1=(lapse_rate(T_skewt[0],T_skewt[3],hgt_skewt[0],hgt_skewt[3]))
        lapse2=(lapse_rate(T_skewt[0],T_skewt[7],hgt_skewt[0],hgt_skewt[7]))
        lapse3=(lapse_rate(T_skewt[0],T_skewt[11],hgt_skewt[0],hgt_skewt[11]))
        lapse6=(lapse_rate(T_skewt[0],T_skewt[19],hgt_skewt[0],hgt_skewt[19]))
        lapse3_6=(lapse_rate(T_skewt[11],T_skewt[19],hgt_skewt[11],hgt_skewt[19]))
        avgrh=np.mean(rh[11:20])
    
    print('0-1 km lapse rate:',lapse1,'C/km') 
    print('0-2 km lapse rate:',lapse2,'C/km')    
    print('0-3 km lapse rate:',lapse3,'C/km') 
    print('0-6 km lapse rate:',lapse6,'C/km')
    print('1-3 km lapse rate:',lapse_rate,'C/km')
    print('3-6 km lapse rate:',lr_36,'C/km')
    #print('Avgerage 700-400 hPa RH:',avgrh.m,'%')
    
    #converts lapse rates to float and demensionless
    new_lapse3=float(lapse3) 
    new_lapse6=float(lapse6)
    new_lapse3_6=float(lr_36)
    ...
    ax3 = fig.add_axes([0.388,0.7,0.1,0.18])
    ax4 = fig.add_axes([0.241,0.7,0.1,0.18])
    ...
    ax3.plot(thermo.ktoc(prof.thetae), prof.hght, 'r-', label='Theta-E')
    ax3.plot(thermo.ktoc(prof.theta), prof.hght, 'g-', label='Theta')
    ax3.set_ylim(0, 20000)
    ax3.set_xlim(-50, 160)
    #ax3.set_xlabel("Temperature [C]")
    #ax3.set_ylabel("Height [m above MSL]")

    ax3.get_yaxis().set_visible(False)
    ax3.legend()

    ax4.plot(RH_skewt, hgt_skewt, color='darkgreen', label='RH')
    ax4.plot(mixr_skewt, hgt_skewt, color='g', label='MixRat', alpha=0.5)
    #ax4.plot(Omega[0], hgt_skewt[0], color='c', alpha=0.5)
    ...
    plt.figtext( 0.15, 0.37, 'Levels (m):', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.35, 'LCL:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.35, f'{lcl}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.33, 'LFC:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.33, f'{lfc}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.31, 'EL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.31, f'{el}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.29, 'MPL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.29, f'{mpl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.27, 'CCL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.27, f'{ccl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.25, 'FZL:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.25, f'{hgt0c}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.23, 'PBL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.23, f'{pbl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.21, 'EIB:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.21, f'{ebot_hght}', fontsize=12, backgroundcolor='white', color='black')
    ...
    plt.figtext( 0.452, 0.15, 'RH$_<lcl$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.452, 0.13, 'RH$_{LCL-LFC}$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.452, 0.11, 'RH$_{1-3km}$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.452, 0.09, 'RH$_{HGZ}$:', fontsize=12, backgroundcolor='white', color='black')
    ...
    plt.figtext( 0.313, 0.05, 'LR$_3-6km$:', fontsize=12, backgroundcolor='white', color='black')
    ...
    plt.figtext( 0.313, 0.03, 'LR$_1-3km$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.346, 0.03, f'{lr_36}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.313, 0.01, 'LR$_max$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.381, 0.05, 'CAPE$_{HGZ}$:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.381, 0.03, 'CAPE$_{MPL}$:', fontsize=12, backgroundcolor='white', color='black')
    ...
    plt.figtext( 0.68, 0.85, 'Mean Wind (kts)', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.72, 0.83, f'{mean1}', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.68, 0.83, '0-1km:', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.68, 0.81, '0-3km:', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.72, 0.81, f'{mean_3}', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.68, 0.79, 'PBL:', fontsize=14, backgroundcolor='white', color='black')
    plt.figtext( 0.72, 0.79, f'{meanpbl}', fontsize=14, backgroundcolor='white', color='black')
    ...
    plt.figtext ( 0.58, 0.73, 'Eff. SRH:', fontsize=14, backgroundcolor='white', color='black')
    #plt.figtext ( 0.63, 0.73, f'{effective_srh}', fontsize=14, backgroundcolor='white', color='black')
    ...
    h.ax.scatter(hgt_points[0][0], hgt_points[1][0], s = 48, color = 'purple', zorder=10)
    h.ax.scatter(hgt_points[0][1], hgt_points[1][1], s = 48, color = 'red', zorder=10)
    h.ax.scatter(hgt_points[0][2], hgt_points[1][2], s = 48, color = 'orange', zorder=10)
    h.ax.scatter(hgt_points[0][3], hgt_points[1][3], s = 48, color = 'yellow', zorder=10)
    h.ax.scatter(hgt_points[0][4], hgt_points[1][4], s = 48, color = 'grey', zorder=10)
    ...
    def plotHodo(axes, hgt_skewt, u_skewt, v_skewt, color='k'):
        for color, min_hght in zip(['r', 'g', 'b', 'k'], [3000,6000,9000,12000]):
            axes.plot(u_skewt, v_skewt, color +'-', lw=2)

    h = plotHodo(ax1, hgt_skewt, u_skewt, v_skewt)
    c = h.plot_colormapped(u_skewt[::-1], v_skewt[::-1], hgt_skewt[::-1]-hgt_skewt[-1])
    #h.add_grid(increment=20)
    '''
